...
- generic [ref=e1]:
  ...
  - generic [ref=e12]:
    ...
    - group "Suggession Class Example" [ref=e23]:
      ...
      - textbox "Type to Select Countries" [ref=e25]: Ind
            ...
            - generic:
              - generic:
                - generic:
                  ...
                  - strong: RAHULSHETTY21051
                  - text: at checkout.
                - generic:
                  - generic: "Ends in:"
                  - generic: 1d 5h 41m 51s
              - button:
                - img
          - generic:
            - navigation:
  ...
  - status [ref=e236]:
    - generic [ref=e237]: 3 results are available, use up and down arrow keys to navigate.
```